use fogrs_common::packet_structs::{construct_gdp_response_with_guid, Packet};
use fogrs_common::{
...
impl ROSManager {
    ...
    pub async fn handle_ros_topic_local_service(
        self, mut status_recv: UnboundedReceiver<TopicManagerRequest>,
        fib_tx: UnboundedSender<GDPPacket>, channel_tx: UnboundedSender<FibStateChange>,
    ) {
        info!("ros_service_handler has started");
    ...
    pub async fn handle_ros_topic_local_client(
        self, mut status_recv: UnboundedReceiver<TopicManagerRequest>,
        fib_tx: UnboundedSender<GDPPacket>, channel_tx: UnboundedSender<FibStateChange>,
    ) {
        info!("ros_client_handler has started");
